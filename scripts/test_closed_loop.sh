...
#       Default PID: u 100:80:350:50 (raised 2026-09-02 to cut dead time before
#       breakaway; floor-verified with real load via a spin-in-place sweep).
...
echo "- Never moves at all? Raise I (u 100:80:450:50). Overshoots/hunts? Lower I or raise D."
